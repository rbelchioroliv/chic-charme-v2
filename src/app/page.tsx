...
import prisma from "@/lib/prisma"; // <-- Importamos a conexão direta com o DB!

// A página agora é "async" para poder ir ao banco de dados
export default async function Home() {
  // Puxa as últimas 8 joias inseridas no painel de administração
  ...
  return (
    <div className="pb-24">
      <section className="relative bg-dark-900 px-4 py-20 lg:py-32 overflow-hidden mb-20 text-white">
        {/* ... (Todo aquele código visual do Hero Section que já tínhamos) ... */}
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="z-10">
            ...
            <p className="text-lg text-gray-400 mb-10 max-w-md leading-relaxed font-light">
              Descubra semijoias exclusivas com banho de alta qualidade e garantia. Feitas para destacar a sua luz própria.
            </p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <p className="text-dark-700">As peças mais desejadas do momento.</p>
          </div>
        ...
        {/* Mapeia os produtos REAIS que vieram do Prisma */}
        {products.length > 0 ? (
